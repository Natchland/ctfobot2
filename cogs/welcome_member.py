...
class WelcomeMember(commands.Cog):
    ...
    async def _send_welcome(self, member: discord.Member):
        ...
        msg = (
            ...
            "- **Base & Bag:** Join a VC to receive your base location and bag.\n"
            ...
            "- **Security Reminder:** For your safety, do not discuss server details or "
            "clan matters in public channels.\n\n"
            "**Important Channels:**\n"
            "- <#1401604218711838893> **Current Server Information**\n"
            "- <#1403891526844551228> **Loot Thread**\n"
            "- <#1414663176666222673> **In-Game Names**\n"
            "- <#1413929735658016899> **Giveaways**\n"
